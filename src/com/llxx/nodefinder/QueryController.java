...
public class QueryController
{
            ...
            AccessibilityNodeInfo fromNode, boolean isCounting)
    {
        ...
        {
            if (DEBUG)
                Log.d(LOG_TAG, "Container selector not found: "
            ...
            UiSelector subSelector, AccessibilityNodeInfo fromNode, int index)
    {
        ...
        for (int i = 0; i < childCount; i++)
        {
            ...
            {
                if (VERBOSE)
                    Log.v(LOG_TAG, String.format("Skipping invisible child: %s",
                            childNode.toString()));
                continue;
            }
            ...
            UiSelector originalPattern)
    {
        ...
        for (int i = 0; i < childCount; i++)
        {
            ...
            {
                if (DEBUG)
                    Log.d(LOG_TAG, String.format("Skipping invisible child: %s",
                            childNode.toString()));
                continue;
            }
    ...
    public String getCurrentPackageName()
    {
        ...
        if (rootNode == null)
            return null;
        return rootNode.getPackageName() != null
